...
""" Main method to initialize and run Flappy Potter game """
...
def main():
    ...
    # this is actually Harry potter, but it's quite a hassle to rename everything
    gameBird = Bird()
    ...
    while gameVariables.waitClick == True:
        ...
        # when the user clicks somewhere, harry will jump and the game will start
        ...
        # a new harry is 'drawn' every time it moves
        gameBird.redraw(screen, gameImages['harry'], gameImages['harry'])
    ...
    while True:
        ...
        # harry went through one half of the pipe's gameWidth; if so, we update the gameScore
        for p in gamePipes:
    ...
    # make harry 'fall' if the round is over
    while gameBird.bird_y + birdHeight < gameHeight - groundHeight:
        ...
        gameBird.redraw_dead(screen, gameImages['harry'])
