...
def initialize_pygame():
    ...
    pygame.display.set_caption("Flappy Potter")

    return screen

# these images will be called in FlappyPotter.py to generate the graphics
def load_images():
    # loading all the images required for the game from the images folder
    # and returning a dictionary of them as following:

    # 'background' : the background
    # 'harry' : the yogi figure
    # 'harry2' : the yogi with the tail down
    # 'pipe-up' : the 'pipe' for the upper part, represented by a suspended sword
    # 'pipe-down' : the 'pipe' for the lower part, represented by a fire
    # 'ground' : the ground
    ...
    return {'background': load_image('background.png'),
            ...
            'harry': load_image('harry.png'),
            'pipe-up': load_image('sword.png'),
            'pipe-down': load_image('fire.png'),
            'ground': load_image('ground.png')}

# generic method to grab font and render text according to coordinates
